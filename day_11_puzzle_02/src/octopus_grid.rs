...
impl OctopusGrid {
    ...
    pub fn compute_synchronized_flash_step(&self) -> Option<u32> {
        ...
        for step in 1.. {
            ...
            if has_flashed_octopi.len() == energy_levels_buffer.len() {
                return Some(step);
            }
...
5283751526"
        ...
        assert_eq!(Some(195), grid.compute_synchronized_flash_step());
    }
}